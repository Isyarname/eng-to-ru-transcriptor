...
Python-библиотека для автоматической транскрипции английского текста кириллицей. Использует гибридный движок: поиск по словарю и правила транскрипции для неизвестных слов.
...
- **Двухуровневый поиск** — IPA через локальный словарь (120 000+ слов) + правила транскрипции в качестве запасного варианта.
